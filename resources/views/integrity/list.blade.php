            ...
            <div class="card">
                ...
                <div class="card-header p-2">
                    <ul class="nav nav-pills">
                        <li class="nav-item"><a class="nav-link active" href="#evidences" data-toggle="tab">Evidencias</a>
                        </li>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($evidences as $evidence)
                                        <tr>
                                            ...
                                            <td><a
                                                    href="{{ route('profiles.view.evidence', ['id_user' => $evidence->user->id, 'id_evidence' => $evidence->id]) }}">{{ $evidence->title }}</a>
                                            </td>
                                            <td class="d-none d-sm-none d-md-table-cell d-lg-table-cell"><a
                                                    href="{{ route('profiles.view', ['id' => $evidence->user->id]) }}">{{ $evidence->user->surname }},
                                                    {{ $evidence->user->name }}</a></td>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($proofs as $proof)
                                        <tr>
                                            ...
                                            <td class="d-none d-sm-none d-md-table-cell d-lg-table-cell">
                                                {{ $proof->evidence->title }}</td>
                                            <td class="d-none d-sm-none d-md-table-cell d-lg-table-cell">
                                                {{ $proof->evidence->user->surname }}, {{ $proof->evidence->user->name }}
                                            </td>
                                            <td class="d-none d-sm-none d-md-table-cell d-lg-table-cell">
                                                {{ \Carbon\Carbon::parse($proof->created_at)->diffForHumans() }} </td>
                                            <td class="text-center">
                                                @if ($proof->integrity())
                                                    <i style="color: green" class="fas fa-check-circle"></i>
                                                @else
