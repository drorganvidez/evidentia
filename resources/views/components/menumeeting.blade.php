        ...
        <ul class="nav nav-pills flex-column">
            ...
            <li class="nav-item">
                <a href="{{ route('secretary.meeting.manage.request.create') }}"
                   class="nav-link {{ Route::currentRouteName() == 'secretary.meeting.manage.request.create' ? 'active bg-light text-dark fw-bold' : '' }}">
            ...
            <li class="nav-item">
                <a href="{{ route('secretary.meeting.manage.signaturesheet.create') }}"
                   class="nav-link {{ Route::currentRouteName() == 'secretary.meeting.manage.signaturesheet.create' ? 'active bg-light text-dark fw-bold' : '' }}">
