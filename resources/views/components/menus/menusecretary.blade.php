@if(\Illuminate\Support\Facades\Auth::user()->hasRole('SECRETARY'))
    ...
    <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <x-li route="secretary.meeting.manage" icon='far fa-handshake' name="Gestionar reuniones" secondaries="secretary.meeting.manage.request.create,secretary.meeting.manage.request.list"/>
