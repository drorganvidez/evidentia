@if (\Illuminate\Support\Facades\Auth::user()->hasRole('PRESIDENT'))
    <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <x-li route="president.user.list" secondaries="president.user.management" icon='nav-icon fas fa-users-cog'
            ...
            <x-li route="president.committee.list" icon='fas fa-sitemap' name="Gestionar comités" />
