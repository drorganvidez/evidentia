@if (\Illuminate\Support\Facades\Auth::user()->hasRole('LECTURE'))
    <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <x-li route="lecture.user.list" secondaries="lecture.user.management,lecture.user.management"
                icon='nav-icon fas fa-users-cog' name="Gestionar alumnos" />
            ...
            <x-li route="lecture.committee.list" icon='fas fa-sitemap' name="Gestionar comités" />
