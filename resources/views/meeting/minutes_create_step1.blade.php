                    ...
                    <div class="bs-stepper linear">
                        ...
                        <div class="bs-stepper-content">
                            ...
                            <div id="step_1" class="content active" role="tabpanel">
                                ...
                                <form method="POST"
                                    action="{{ route('secretary.meeting.manage.minutes.create.step1_p') }}">
                                    @csrf
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <select id="meeting_request"
                                                ...
                                                name="meeting_request" value="{{ old('meeting_request') }}" autofocus>
                                                ...
                                                @foreach ($meeting_requests as $meeting_request)
                                                    <option
                                                        {{ $meeting_request->id == old('$meeting_request') ? 'selected' : '' }}
