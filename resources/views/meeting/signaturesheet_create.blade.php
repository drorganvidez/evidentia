...
<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="alert alert-info">
            ...
            <p>Con esta URL, los asistentes podrán firmar con su usuario y contraseña y quedarán registrados.</p>
        </div>

        <form method="POST" action="{{ route('secretary.meeting.manage.signaturesheet.new') }}" id="request_form">
            @csrf
            ...
            <div class="form-row">
                ...
                <x-input col="6" attr="title" :value="$signature_sheet->title ?? ''"
                         label="Título"
