                                ...
                                <div class="bs-stepper-header" role="tablist">
                                    ...
                                    <div class="step">
                                        <button type="button" class="step-trigger" role="tab"
                                            ...
                                            aria-selected="true" disabled="disabled">
                            ...
                            <div class="col-lg-12">
                                <div class="bs-stepper-content">
                                    ...
                                    <div id="step_3" class="content active" role="tabpanel">
                                        ...
                                        <form method="POST"
                                            action="{{ route('secretary.meeting.manage.minutes.create.step3_p') }}"
                                            id="request_form">
                                            @csrf

                                            <input type="hidden" name="meeting_request"
                                            ...
                                            @if ($meeting_request)
                                                <div class="callout callout-info">
                                                    <p>La información que detallaste en la convocatoria se ha volcado
                                                        automáticamente en el formulario.</p>
                                                    <p>Recuerda rellenar <b>las horas y/o los minutos empleados</b> en la
                                                        reunión.</p>
                                                </div>
                                            @endif
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-3">
                                                    ...
                                                    <small class="form-text text-muted">Elige la modalidad de
                                                        reunión.</small>
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-3">
                                                    ...
                                                    <input id="" type="number" min="0" max="60"
                                                        class="form-control" placeholder="" name="minutes"
                                            ...
                                            @if ($signature_sheet)
                                                <div class="callout callout-info">
                                                    <p>Las asistencias firmadas se han volcado automáticamente en el
                                                        formulario.</p>
                                                </div>
                                            @endif
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <select id="defaultlist" onchange="getLista(this);"
                                                        ...
                                                        @foreach ($defaultlists as $defaultlist)
                                                            <option value="{{ trim($defaultlist->id) }}">
                                                                {{ trim($defaultlist->name) }}</option>
                                                        @endforeach
                                                    ...
                                                    <small class="form-text text-muted">
                                                        ...
                                                        @if ($signature_sheet)
                                                            Ten en cuenta que esto <b>eliminará</b> las asistencias volcadas
                                                            desde la hoja de firmas.
                                                        @endif
                                            ...
                                            @if ($meeting_request)
                                                <div class="callout callout-info">
                                                    <p>Los puntos de la orden del día se han volcado automáticamente en el
                                                        formulario.</p>
                                                </div>
                                            @endif
                                                ...
                                                @if (session('points'))
                                                    ...
                                                    @foreach (session('points') as $key => $point)
                                                        <div class="card card-info point_body"
                                                            ...
                                                            <span class="point_id"
                                                                style="display: none">{{ $point['id'] }}</span>
                                                            ...
                                                            <div class="card-body">
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-sm-12">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <input type="text"
                                                                                        class="form-control point_title"
                                                                                        value="{{ $point['title'] }}"
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-lg-6">
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <input type="number"
                                                                                        class="form-control point_duration"
                                                                                        value="{{ $point['duration'] }}">
                                                                                    <small
                                                                                        class="form-text text-muted">Minutos
                                                                                        que han llevado desarrollar este
                                                                                        punto.
                                                                                    </small>
                                                                                </div>
                                                                ...
                                                                <div id="agreements_{{ $key }}">
                                                                    ...
                                                                    @foreach ($point['agreements'] as $agreement)
                                                                        ...
                                                                        <div class="row point_agreement"
                                                                            id="agreement_{{ $random_id }}">
                                                                            <div class="col-sm-6">
                                                                                <div class="form-group">
                                                                                    <label>Acuerdo</label>
                                                                ...
                                                                <button type="button"
                                                                    onclick="add_agreement({{ $key }})"
                                                                    class="btn btn-light"><i class="fas fa-plus"></i>
                                                                    Añadir acuerdo</button>
                                                    ...
                                                    @if ($meeting_request)
                                                        ...
                                                        @foreach ($meeting_request->diary->diaryPoints as $key => $diary_point)
                                                            <div class="card card-info point_body"
                                                                ...
                                                                <span class="point_id"
                                                                    style="display: none">{{ $diary_point->id }}</span>

                                                                <div class="card-header">
                                                                    <div class="d-flex justify-content-between">
                                                                        <div>
                                                                            <h3 class="card-title">
                                                                                {{ $diary_point->point }}</h3>
                                                                        </div>
                                                                        <div>
                                                                            <button type="button"
                                                                                onclick="delete_point({{ $key }})"
                                                                ...
                                                                <div class="card-body">
                                                                            ...
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-sm-12">
                                                                                    <div class="form-group">
                                                                                        <label>Descripción</label>
                                                                                        <textarea class="form-control point_description" rows="3"
                                                                                            placeholder="Añade una descripción concisa del desarrollo de este punto"></textarea>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                    ...
                                                                    <button type="button"
                                                                        onclick="add_agreement({{ $diary_point->id }})"
                                                                        class="btn btn-light"><i class="fas fa-plus"></i>
                                                                        Añadir acuerdo</button>
                                            ...
                                            <div class="form-row">
                                                <div class="col-lg-3 col-xs-12 mt-1">
                                                    <button type="button" onclick="add_point()"
                                                        class="btn btn-info btn-block"><i
                                                            class="fas fa-sticky-note"></i>&nbsp;&nbsp;Añadir punto al
                                                        acta</button>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-row">
                                                <div class="col-lg-6 mt-1">
                                                    <button type="submit" class="btn btn-primary"><i
                                                            class="fas fa-scroll"></i>&nbsp;&nbsp;Crear acta</button>
                                                </div>
                                            </div>
