...
<body class="hold-transition sidebar-mini layout-navbar-fixed">
                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-12">
                            ...
                            <h1 class="m-0 text-dark"><i class="@yield('title-icon')"></i>&nbsp;&nbsp;@yield('title')
                            </h1>
                        </div>
    ...
    <script>
        ...
        $(".filepond--file-wrapper").on('click', '.filepond--file-action-button.filepond--action-revert-item-processing',
            function() {
        ...
        function countdown(distance) {
            ...
            var x = setInterval(function() {
                ...
                document.getElementById("countdown").innerHTML = days + " días, " + hrs + " horas, " + mnts +
                    " minutos y" +
                    " " + seconds + " segundos";
