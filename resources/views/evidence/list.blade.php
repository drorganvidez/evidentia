                        ...
                        <table id="dataset" class="table table-hover table-responsive">
                            ...
                            <tbody>
                                ...
                                @foreach ($evidences as $evidence)
                                    <tr>
                                        <td class="d-none d-sm-none d-md-table-cell d-lg-table-cell">{{ $evidence->id }}
                                        </td>
                                        <td><a
                                                href="{{ route('evidence.view', ['id' => $evidence->id]) }}">{{ $evidence->title }}</a>
                                        </td>
                                        <td class="d-none d-sm-none d-md-table-cell d-lg-table-cell">{{ $evidence->hours }}
                                        </td>
                ...
                <div class="card-body">
                    ...
                    <div class="mt-3">
                        ...
                        <p class="text-justify">
                            Todas las evidencias deben ser validadas por los coordinadores de comité. Este proceso lleva
                            tiempo, especialmente si alguna es rechazada y debes modificarla.
                            <br><br>
                            Por eso, **no apures el plazo**: subir las evidencias con antelación facilita que los
                            coordinadores las revisen y corrijan dentro del tiempo establecido.
                        </p>
                    </div>
