...
class Suite(unittest.TestCase):
    ...
    if(driver.find_element("xpath", incidencia_con_no_exito).text == 'reason debe contener al menos 10 caracteres.'):
        print('----------------------------------------------------------')
        print('2. TEST EJECUTADO CON ÉXITO: NO SE PUEDE CREAR UNA TRANSACCIÓN UN MENOS DE 10 CARACTERES EN EL MOTIVO');
        print('----------------------------------------------------------')
    else:
        print('----------------------------------------------------------')
        print('2. TEST FALLIDO');
        print('----------------------------------------------------------')